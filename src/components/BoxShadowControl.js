...
const BoxShadowControl = ( {
	label = __( 'Enable Box Shadow', 'gutena-team' ),
	toggleLabel = __( 'On', 'gutena-team' ),
	attrValue,
	...
	const boxShadowAttr = {
		offsetX: __( 'Offset X', 'gutena-team' ),
		offsetY: __( 'Offset Y', 'gutena-team' ),
		blurRadius: __( 'Blur Radius', 'gutena-team' ),
		spreadRadius: __( 'Spread Radius', 'gutena-team' ),
	};
	...
	const controls = (
		<>
			...
			{ ( onBoxShadow || attrValue.onBoxShadow ) &&
				<>
					<BaseControl label={ __( 'Shadow Color', 'gutena-team' ) } className="gutena-box-shadow-color-control">
						<ColorPalette
							colors={ attrColors }
