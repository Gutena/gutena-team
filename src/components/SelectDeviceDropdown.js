...
const SelectDeviceDropdown = ( { 
    ...
    return (
        <HStack justify="flex-start">
            ...
            <DropdownMenu
                label={ __('Select device','gutena-team') }
                className="gutena-team-select-device"
                popoverProps={ {
                    className:"gutena-team-select-device-popover"
                } }
                icon={ selectedIcon }
                controls={ [
                    {
                        title: __( 'Desktop', 'gutena-team' ),
                        icon: desktopIcon,
                        onClick: () => setDeviceType( 'Desktop' ),
                    },
                    {
                        title: __( 'Tablet', 'gutena-team' ),
                        icon: tabletIcon,
                        onClick: () => setDeviceType( 'Tablet' ),
                    },
                    {
                        title: __( 'Mobile', 'gutena-team' ),
                        icon: mobileIcon,
